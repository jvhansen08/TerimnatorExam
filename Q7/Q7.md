...
As noted above, given the amiguity of the question description, we have assumed that the cost of moving from 1 to 2 is the same as moving from 1 to 3 (regular moving cost + 1, where 1 is the cost for elevation up).
